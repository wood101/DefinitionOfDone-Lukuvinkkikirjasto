...
public class InMemoryDaoTest {
    ...
    @Test
    public void listByKeywordReturnsCorrectTipsWhenSearchedByAuthor() {
        List<ReadingTip> filtered = dao.listByKeyword("hackerdashery4");
        assertTrue(filtered.get(0).getAuthor().equals("hackerdashery4"));
    }
    
    @Test
    public void listByKeywordReturnsCorrectTipsWhenSearchedByTitle() {
        List<ReadingTip> filtered = dao.listByKeyword("P vs. NP and the Computational Complexity Zoo2");
        assertTrue(filtered.get(0).getAuthor().equals("hackerdashery2"));
    }
    
    @Test
    public void listByKeywordReturnsCorrectTipsWhenSearchedByYear() {
        List<ReadingTip> filtered = dao.listByKeyword("2014");
        assertTrue(filtered.get(0).getAuthor().equals("hackerdashery"));
    }
